...
class QuestionsController < ApplicationController
  ...
  def create
    ...
    openai_client = OpenAI::Client.new(api_key: "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", default_engine: "text-davinci-003")
  ...
  def test
    openai_client = OpenAI::Client.new(api_key: "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", default_engine: "ada")
